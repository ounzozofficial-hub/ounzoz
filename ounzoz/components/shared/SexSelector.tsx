...
// only covers text/number fields. Moved to components/shared/ once a
// second tool (TDEE Calculator) needed the same sex input that BMR
// Calculator introduced (CLAUDE.md Section 4 golden rule: extract once
// genuinely shared by 2+ tools).
