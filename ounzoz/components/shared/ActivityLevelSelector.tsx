...
import { ACTIVITY_LEVEL_LABELS } from '@/lib/formulas/activity-multiplier';
...
//
// Moved to components/shared/ once a second tool (Calorie Calculator)
// needed the same activity-level input that TDEE Calculator introduced
// (CLAUDE.md Section 4 golden rule: extract once genuinely shared by 2+
// tools) — same pattern as SexSelector's move last phase. Its data
// (ACTIVITY_LEVEL_LABELS) comes from lib/formulas/activity-multiplier.ts,
// not from any tool's calculator file, so this component doesn't create
// a dependency on TDEE Calculator or Calorie Calculator specifically.
